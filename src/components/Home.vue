...
<div>
	<div class="page-wrapper chiller-theme toggled">
			...
			<div class="sidebar-menu">
				...
				<li class="sidebar-dropdown arrow">
					...
					<div class="sidebar-submenu">
						<ul>
							<li><router-link :to="{ name: 'UserRegister' }">Create</router-link></li>
							<li><router-link :to="{ name: 'UserList' }">Listing</router-link></li>
						</ul>
					</div>
				</li>
				<li class="sidebar-dropdown arrow">
					...
					<div class="sidebar-submenu">
					<ul>
						<li><router-link :to="{ name: 'CreateProduct' }">Create</router-link></li>
						<li><router-link :to="{ name: 'ProductList' }">Listing</router-link></li>
					</ul>
					</div>
				</li>
				<li class="sidebar-dropdown arrow">
					...
					<div class="sidebar-submenu">
					<ul>
						<li><router-link :to="{ name: 'CreateCategory' }">Create</router-link></li>
						<li><router-link :to="{ name: 'CategoryList' }">Listing</router-link></li>
					</ul>
					</div>
				</li>
				<li class="sidebar-dropdown arrow">
		...
		<main class="page-content">
			<div class="pages">
				<b-button variant="secondary" size="sm" @click="pageReload()"><b-icon icon="arrow-repeat"></b-icon> Refresh Page</b-button>
				<b-button variant="secondary" size="sm" @click="previousPage()"><b-icon icon="chevron-double-left"></b-icon> Previouse Page</b-button>
				<b-button variant="secondary" size="sm" @click="nextPage()">Next Page <b-icon icon="chevron-double-right"></b-icon></b-button>
			</div>
			<div class="content">
				<Layout></Layout>
			</div>
...
<style>
	...
	.sidebar-wrapper .sidebar-menu .sidebar-dropdown.arrow > a:after {
